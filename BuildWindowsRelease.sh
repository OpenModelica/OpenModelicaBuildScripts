...
export OPENMODELICAHOME="c:\\OM111\\OpenModelica${PLATFORM}\\build"
export OPENMODELICALIBRARY="c:\\OM111\\OpenModelica${PLATFORM}\\build\\lib\\omlibrary"

# have OMDEV in Msys version
export OMDEV=/c/OM111/OMDev/
...
cd /c/OM111/OpenModelica${PLATFORM}/OpenModelicaSetup
svn up . --accept theirs-full
...
rm -rf OMPython
git clone https://github.com/OpenModelica/OMPython -q -b master /c/OM111/OpenModelica${PLATFORM}/OMPython
# build OMPython
...
cd /c/OM111/OpenModelica${PLATFORM}/build/share/doc/omc
wget --no-check-certificate https://openmodelica.org/doc/openmodelica-doc-v1.11.0.tar.xz
tar -xJf openmodelica-doc-v1.11.0.tar.xz --strip-components=2
rm openmodelica-doc-v1.11.0.tar.xz
wget --no-check-certificate https://openmodelica.org/doc/OpenModelicaUsersGuide/OpenModelicaUsersGuide-v1.11.0.pdf
cp OpenModelicaUsersGuide-v1.11.0.pdf OpenModelicaUsersGuide-latest.pdf
...
git clone https://github.com/PySimulator/PySimulator -q -b master /c/OM111/OpenModelica${PLATFORM}/build/share/omc/scripts/PythonInterface/PySimulator
...
cd public_html/omc/builds/windows/releases/1.11/maintenance/${PLATFORM}/
mv -f OpenModelica* older/ || true
ENDSSH
scp OpenModelica*${PLATFORM}* ${SSHUSER}@build.openmodelica.org:public_html/omc/builds/windows/releases/1.11/maintenance/${PLATFORM}/
echo "All done!"
